...
export const metadata: Metadata = {
  ...
  description: "Official website of Zeno Academy University",
    generator: 'v0.dev'
}
            ...
            <div className="flex min-h-screen flex-col">
              ...
              <div className="bg-gray-900 text-white text-xs py-1 px-4 flex justify-between items-center">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <a href="mailto:admin@zeno.edu.kg">admin@zeno.edu.kg</a>
                </div>
                {/* Right Side: Time & Social Icons */}
                <div className="flex items-center gap-4"> {/* Group Time and Icons */}
                  {/* Time */}
                  <div className="flex items-center gap-2">
                     ...
                     <span>Mon-Sat: 8:00am To 3:00pm</span>
                  </div>
                  {/* Social Icons */}
                  <div className="flex items-center gap-3">
                    <a href="#" aria-label="Facebook" className="hover:text-gray-400">
                      <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>
                    </a>
                    <a href="#" aria-label="Google Plus" className="hover:text-gray-400">
                      {/* Using a generic link icon as Google+ is deprecated */}
